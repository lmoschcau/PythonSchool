...
class BackTrackSimple:
    ...
    def Reise(self, von):
        ...
        self.kWeg.strecken = [StreckeWeg(self.aWeg.strecken[i].von, self.aWeg.strecken[i].nach) for i in range(self.aWeg.index + 1)]
...
for Index in range(TrackErgebniss.index + 1):
    print(str(TrackErgebniss.strecken[Index].von) + ' -> ' + str(TrackErgebniss.strecken[Index].nach) + ' (' +  'km)')
